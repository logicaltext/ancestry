...
The Ancestry gem comes with a unit test suite consisting of about 1800 assertions in about 30 tests. It takes about 20 seconds to run on sqlite. To run it yourself, run 'rake test'. The test suite is located in +test/has_ancestry_test.rb+.
