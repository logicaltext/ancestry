...
class ActiveRecord::Base
  def self.has_ancestry options = {}
    ...
    scope :ordered_by_ancestry, order("#{ancestry_column} is not null, #{ancestry_column}")
    scope :ordered_by_ancestry_and, lambda { |arg| order("#{ancestry_column} is not null, #{ancestry_column}, #{arg}") }
